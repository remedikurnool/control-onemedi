...
// Mock specializations since the table doesn't exist
const mockSpecializations = [
  { id: '1', name_en: 'Cardiology', name_te: 'హృదయ వైద్యం', is_active: true },
  { id: '2', name_en: 'Neurology', name_te: 'న్యూరాలజీ', is_active: true },
  { id: '3', name_en: 'Orthopedics', name_te: 'ఆర్థోపెడిక్స్', is_active: true },
  { id: '4', name_en: 'Pediatrics', name_te: 'పిల్లల వైద్యం', is_active: true },
  { id: '5', name_en: 'Dermatology', name_te: 'చర్మ వైద్యం', is_active: true },
];
        ...
        if (selectedDoctor) {
          ...
          const { data, error } = await supabase
            ...
            .insert({
              ...
              status: 'offline',
              is_verified: false,
              user_id: 'temp-user-id' // This should be the actual user ID
            })
            .select();
